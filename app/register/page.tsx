            ...
            <div className='w-full lg:w-1/2 flex flex-col items-center justify-center p-6 sm:p-10 lg:p-20'>
                <div className='w-full max-w-md'>
                    <div className='mb-8 text-center lg:text-left'>
                        <h1 className='text-2xl sm:text-3xl font-bold mb-2'>Criar uma nova conta</h1>
                    ...
                    <div className='mt-8 text-sm text-center text-[var(--foreground-secondary)]'>
                        <span>
                           EU ja tenho uma conta? <Link href={"/login"} className='text-[var(--primary-color)] hover:underline'>Log In</Link>
                        </span>
                    </div>
